...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        if status1 == 2 and status2 == 2:
            ...
            count += 1
            cv2.putText(frame, "Eyes Closed, Frame count: " + str(count), (10, 30), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 255), 1)
          
            if count >= 10:
                cv2.putText(frame, "Drowsiness Alert!!!", (100, height-20), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 255), 2,cv2.LINE_AA)
                if not alarm_on:
                    alarm_on = True
                    # play the alarm 
            ...
            cv2.putText(frame, "Eyes Open", (10, 30),cv2.FONT_HERSHEY_COMPLEX_SMALL, 1,(255,255,255),1,cv2.LINE_AA)
            count = 0
            alarm_on = False
